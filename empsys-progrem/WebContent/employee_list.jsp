...
<head>
	...
	function delete_employee(){
		...
		if(window.confirm('削除しますか？')){
			...
			document.getEmementsByName("operation").value = "delete";
			return true;
		}else{
			// 「キャンセル」時の処理
			...
			<input type="hidden" name="screen_transition" value="employee_list" />
			 <table id="table-01" summary="" border="1">
				...
				<tr>
					...
					<%
					String birthday = "";
					String bean_birthday = bean.getBirthday();
					if(bean_birthday.equals("0000-00-00")){
						birthday = "";
					}else{
						birthday = bean_birthday;
					}
					%>
					<%=birthday %>
					</td>
					...
					<%
					String emp_date = "";
					String bean_empdate = bean.getEmp_date();
					if(bean_empdate.equals("0000-00-00")){
						emp_date = "";
					}else{
						emp_date = bean_empdate;
					}
					%>
					<%=emp_date %></td>
