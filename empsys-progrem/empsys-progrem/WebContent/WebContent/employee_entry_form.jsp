...
<body>
	...
	<tr>
		...
		<td align="left">：<input type="text" name="last_name" maxlength="5" size="5"></td>
	</tr>
	<tr>
		<td align="center">名</td>
		<td align="left">：<input type="text" name="first_name" maxlength="5" size="5"></td>
	</tr>
	<tr>
		<td align="center">氏(ふりがな)</td>
		<td align="left">：<input type="text" name="last_name_kana" maxlength="10" size="17"></td>
	</tr>
	<tr>
		<td align="center">名(ふりがな)</td>
		<td align="left">：<input type="text" name="first_name_kana" maxlength="10" size="17"></td>
	</tr>
	<tr>
